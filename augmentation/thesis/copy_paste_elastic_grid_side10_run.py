...
try:
    ...
    print("필수 라이브러리가 설치되지 않았습니다. 'pip instcopy_paste_elastic_grid_side10_runall ultralytics matplotlib pandas'를 실행해주세요.")
    exit()
...
def main():
    ...
    TRAIN_DATA_DIR = BASE_DATA_PATH / "train_augmented(elastic_grid_copy_paste_side25)"
    VAL_DATA_DIR = BASE_DATA_PATH / "val"
    OUTPUT_DIR = BASE_DATA_PATH / "yolov8_training_results/elastic_grid_copy_paste_side25"
